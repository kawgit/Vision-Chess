...
CXX_FLAGS = -O3 -Wall -Wshadow -march=native -flto
CXX_COMPILER = g++
...
Vision: build/attacks.o build/bits.o build/eval.o build/hash.o build/move.o build/movegen.o build/pos.o build/search.o build/timer.o build/types.o build/util.o src/main.cpp
...
build/attacks.o: src/attacks.cpp src/attacks.h
	$(CXX_COMPILER) -c $(CXX_FLAGS) src/attacks.cpp -o build/attacks.o
