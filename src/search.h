...
// 	ThreadInfo(Pos& p, std::string id_ = "");
// };
...
// 		cm_hueristic[pos.get_mailbox(pos.notturn, move::to_square(pos.last_move())) - PAWN][move::to_square(pos.last_move())] = move;
// 		hist_hueristic[pos.get_mailbox(pos.turn, move::from_square(move)) - PAWN][move::to_square(move)]++;
// 		hist_score_max++;
...
// 		return ((pos.last_move() != MOVE_NONE) ? (cm_hueristic[pos.get_mailbox(pos.notturn, move::to_square(pos.last_move())) - PAWN][move::to_square(pos.last_move())]) : MOVE_NONE);
// 	}

// 	inline Score get_hist(Pos& pos, Move move) {
// 		return hist_hueristic[pos.get_mailbox(pos.turn, move::from_square(move)) - PAWN][move::to_square(move)];
// 	}
// };
